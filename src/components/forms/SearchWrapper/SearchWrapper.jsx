...
import SearchButton from "../SearchButton/SeacrhButton"
...
function SearchWrapper () {
  ...
  function getWeatherCity(searchCity) {
    ...
    axios.get(`http://api.openweathermap.org/data/2.5/weather?q=${requestCity}&appid=${process.env.REACT_APP_API_KEY}`)
    .then((data) => {
